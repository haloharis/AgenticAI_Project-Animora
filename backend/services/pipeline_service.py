...
class PipelineService:
    ...
    async def create_job(self, prompt: str, style: str = "cinematic") -> str:
        job_id = str(uuid.uuid4())
        await self.job_queue.enqueue(job_id, prompt, style)
        return job_id
    ...
    async def rerun_phase(self, job_id: str, phase: str, workflow) -> Optional[PipelineState]:
        return await workflow.rerun_phase(job_id, phase)
