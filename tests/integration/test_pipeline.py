...
Run only when environment variables GROQ_API_KEY, CF_API_TOKEN, CF_ACCOUNT_ID, DEEPGRAM_API_KEY
...
def has_api_keys():
    missing = [
        k for k in ["GROQ_API_KEY", "CF_API_TOKEN", "CF_ACCOUNT_ID", "DEEPGRAM_API_KEY"]
